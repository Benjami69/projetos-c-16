...
if(greenB.isTouching(arrowGroup)  ||   arrowGroup.isTouching(greenB)){
...
if(blueB.isTouching(arrowGroup)  ||   arrowGroup.isTouching(blueB)){ 
...
score = score +1
 ...
 if(pinkB.isTouching(arrowGroup)  ||  arrowGroup.isTouching(pinkB)){
